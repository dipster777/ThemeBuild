...
*/
/*
Template Name: Planners Contact Us
*/
get_header(); ?>
...
<form action="/plannerprocess.php" onsubmit="return sendForm()" method="post">   
    <table width="670" style="font-size:11px;" border="1" cellspacing="0" cellpadding="0" id="cForm" >
  <tr>
...
<!--other form-->   
    <table width="380" border="0" cellspacing="0" cellpadding="0" id="fInnerTbl" style="margin-top:-10px;">
  <tr>
...
<!--other form-->    
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="right" style="height:30px; line-height:30px; padding-right:0; margin:0;"><input type="hidden" name="infoRequested" id="infoRequested" /><input name="" type="submit" value="submit enquiry" style="background:none; border:0; color:#fbba00; cursor:pointer; margin-top:3px; font-family:Arial, Helvetica, sans-serif;" onmouseout="this.style.textDecoration='none'" onmouseover="this.style.textDecoration='underline'" /></td>
  </tr>
  <tr>
    ...
    <div id="contactSide">
        ...
        <div class="contactRight_bx">
            ...
            <input style="color: #9E9E9E;width:170px;
    float: left;
    font-family: Arial,Helvetica,sans-serif;
    font-size: 1em;" name="saddr" type="text" onblur="if (this.value == '') {this.value = 'Enter postcode for directions';}" onfocus="if (this.value == 'Enter postcode for directions') {this.value = '';}" value="Enter postcode for directions" onclick="this.value='';" />
    ...
    float: left;
    font-family: Arial,Helvetica,sans-serif;
    font-size: 1em;" name="saddr" type="text" onblur="if (this.value == '') {this.value = 'Enter postcode for directions';}" onfocus="if (this.value == 'Enter postcode for directions') {this.value = '';}" value="Enter postcode for directions" />
