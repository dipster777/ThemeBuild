...
*/
/*
Template Name: Planners St Diaries
*/
get_header(); ?>
...
<?php do_action('wp_menubar','planners_student_diaries'); ?><!--gets the sidebar nav for the page template-->
</div>
...
<?php if(is_page(3950)) { include ('studentdiaries.php'); } ?>
